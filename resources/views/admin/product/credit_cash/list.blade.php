...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h4 class="py-4">Список Кредитов наличными</h4>
      <p class="my-4">
        ...
        <form id="search" class="my-4" action="{{ route('admin.products.credit-cash.index') }}">
      ...
      <form id="all-action" action="{{ route('admin.products.credit.cash.all') }}" method="POST">
        @csrf
        @method('POST')
        ...
        <div class="table-responsive">
          <table id="credit_cash_list" class="table table-bordred table-striped">
              ...
              @foreach ($credits as $credit)
                 <tr>
                  <td><input type="checkbox" form="all-action" class="checkthis" name="ids[]" value="{{$credit->id}}" /></td>
                    ...
                    <td>{{$credit->slug}}</td>
                    <td>
                      <a href="{{ route('admin.products.credit-cash.edit', $credit) }}" class="btn btn-primary btn-xs" data-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                    </td>
                    <td>
                      ...
                      {!! Form::open([
                          'method' => 'DELETE',
                          'route' => ['admin.products.credit-cash.destroy', $credit->id],
