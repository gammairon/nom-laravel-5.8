            ...
            @foreach ($mfos as $mfo)
                <div class="row catalog-mfo__product">
                    <div class="col-4 col-md-3 col-lg-2 catalog-mfo__item">
                        <div class="mfo-img">
                            <a href="#" data-href="{{$mfo->ref_link}}" title="{{$mfo->name}}" rel="nofollow" class="redirect" target="_blank">
                                @if($mfo->hasPrimary())
                                    <img class="mfo_logo lazyload" data-src="{{$mfo->getPrimary()->getUrl('thumb')}}" alt="{{$mfo->getPrimaryAlt()}}" title="{{$mfo->getPrimaryTitle()}}" width="300" height="121">
                                @endif
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mb-0 mt-0 col-md-3 col-lg-2 d-flex flex-column catalog-mfo__item justify-content-center align-items-lg-center">
                        <a href="#" data-href="{{$mfo->ref_link}}" class="button redirect" rel="nofollow" target="_blank">Оформить</a>
