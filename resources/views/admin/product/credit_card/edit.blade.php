                                ...
                                <div class="col-xs-12 col-md-8 offset-md-2">
                                    <div class="form-group photo-wrap">
                                        <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" type="text" name="primary_media[url]" value="{{old('primary_media.url', $creditCard->getPrimaryUrl())}}">

                                        </div>
                                        <div class="row">
                                            <div class="col-xs-12 col-md-4">
                                                <img id="holder" class="holder" src="{{old('primary_media.url', $creditCard->getPrimaryUrl())}}">
                                            </div>
                                            <div class="col-xs-12 col-md-8">
                                                <div class="mb-3">
                                                    <label for="alt_logo" class="col-form-label text-md-right">{{ __('Alt') }}</label>
                                                    <input id="alt_logo" class="form-control" type="text" name="primary_media[alt]" value="{{old('primary_media.alt', $creditCard->getPrimaryAlt())}}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="title_logo" class="col-form-label text-md-right">{{ __('Title') }}</label>
                                                    <input id="title_logo" class="form-control" type="text" name="primary_media[title]" value="{{old('primary_media.title',  $creditCard->getPrimaryTitle())}}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" >{{ config('app.url').'/'.$creditCard->getSlugPrefix() }}</span>
                                            </div>
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text"><a href="{{ route('products.cards.single', ['slug' => $creditCard->slug]) }}" target="_blank">Просмотреть</a></span>
                                            </div>
                            ...
                            <div class="row">
                                        ...
                                        <div>
                                            <select id="organization_id" class="form-control{{ $errors->has('organization_id') ? ' is-invalid' : '' }}" name="organization_id" required>
                                                ...
                                                @foreach ($banks as $id => $name)
                                                    <option value="{{$id}}" {{selectedOld('organization_id', $id, $creditCard->organization_id)}}>{{$name}}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="ref_link" type="text" class="form-control{{ $errors->has('ref_link') ? ' is-invalid' : '' }}" name="ref_link" value="{{ old('ref_link', $creditCard->ref_link) }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="rating" type="text" class="numeric form-control{{ $errors->has('rating') ? ' is-invalid' : '' }}" name="rating" value="{{ old('rating', $creditCard->rating) }}" required>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="max_limit" type="text" class="numeric form-control{{ $errors->has('max_limit') ? ' is-invalid' : '' }}" name="max_limit" value="{{ old('max_limit', $creditCard->max_limit) }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="income_max_limit" type="text" class="numeric form-control{{ $errors->has('income_max_limit') ? ' is-invalid' : '' }}" name="income_max_limit" value="{{ old('income_max_limit', $creditCard->income_max_limit) }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="grace_period" type="number" class="numeric form-control{{ $errors->has('grace_period') ? ' is-invalid' : '' }}" name="grace_period" value="{{ old('grace_period', $creditCard->grace_period) }}" required>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="rate_in" type="text" class="numeric form-control{{ $errors->has('rate_in') ? ' is-invalid' : '' }}" name="rate_in" value="{{ old('rate_in', $creditCard->rate_in) }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="rate_after" type="text" class="numeric form-control{{ $errors->has('rate_after') ? ' is-invalid' : '' }}" name="rate_after" value="{{ old('rate_after', $creditCard->rate_after) }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="service" type="text" class="form-control{{ $errors->has('service') ? ' is-invalid' : '' }}" name="service" value="{{ old('service', $creditCard->service) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="cash_back" type="text" class="numeric form-control{{ $errors->has('cash_back') ? ' is-invalid' : '' }}" name="cash_back" value="{{ old('cash_back', $creditCard->cash_back) }}" >
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="loan" type="text" class="numeric form-control{{ $errors->has('loan') ? ' is-invalid' : '' }}" name="loan" value="{{ old('loan', $creditCard->loan) }}">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                       ...
                                       <div>
                                           <textarea name="preview" id="preview" class="form-control">{{old('preview', $creditCard->preview)}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="currency" type="text" class="form-control{{ $errors->has('currency') ? ' is-invalid' : '' }}" name="currency" value="{{ old('currency', $creditCard->currency) }}">
                                ...
                                <div class="col-xs-12 col-md-4">
                                     <div class="form-group">
                                        ...
                                        <div>
                                            <input id="min_age" type="text" class="numeric form-control{{ $errors->has('min_age') ? ' is-invalid' : '' }}" name="min_age" value="{{ old('min_age', $creditCard->min_age) }}" required>
                                 ...
                                 <div class="col-xs-12 col-md-4">
                                     <div class="form-group">
                                        ...
                                        <div>
                                            <input id="max_age" type="text" class="numeric form-control{{ $errors->has('max_age') ? ' is-invalid' : '' }}" name="max_age" value="{{ old('max_age', $creditCard->max_age) }}" required>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                       ...
                                       <div>
                                           <textarea name="list_documents" id="list_documents" class="form-control">{{old('list_documents', $creditCard->list_documents)}}</textarea>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                       ...
                                       <div>
                                           <textarea name="terms_repayment" id="terms_repayment" class="form-control">{{old('terms_repayment', $creditCard->terms_repayment)}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                       ...
                                       <div>
                                           <textarea name="fines_penalties" id="fines_penalties" class="form-control">{{old('fines_penalties', $creditCard->fines_penalties)}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6 pt-4 pb-3">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="chip" name="chip" value="1" {{checked(1, old('chip', $creditCard->chip) )}}>
                                        <label class="form-check-label" for="chip">Чип</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="hidden" name="pay_wave" value="0">
                                    ...
                                    <div class="form-check">
                                        <input type="hidden" name="master_card" value="0">
