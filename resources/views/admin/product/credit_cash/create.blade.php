                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" >{{ config('app.url').'/kredit-nalichnymi/' }}</span>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="min_amount" type="text" class="numeric form-control{{ $errors->has('min_amount') ? ' is-invalid' : '' }}" name="min_amount" value="{{ old('min_amount') }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="max_amount" type="text" class="numeric form-control{{ $errors->has('max_amount') ? ' is-invalid' : '' }}" name="max_amount" value="{{ old('max_amount') }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="income_max_amount" type="text" class="numeric form-control{{ $errors->has('income_max_amount') ? ' is-invalid' : '' }}" name="income_max_amount" value="{{ old('income_max_amount') }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="min_term" type="number" class="numeric form-control{{ $errors->has('min_term') ? ' is-invalid' : '' }}" name="min_term" value="{{ old('min_term') }}" required>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="max_term" type="number" class="numeric form-control{{ $errors->has('max_term') ? ' is-invalid' : '' }}" name="max_term" value="{{ old('max_term') }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="percent_new_individual" type="text" class="numeric form-control{{ $errors->has('percent_new_individual') ? ' is-invalid' : '' }}" name="percent_new_individual" value="{{ old('percent_new_individual') }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="percent_new_legal" type="text" class="numeric form-control{{ $errors->has('percent_new_legal') ? ' is-invalid' : '' }}" name="percent_new_legal" value="{{ old('percent_new_legal') }}" required>
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input id="percent_client" type="text" class="numeric form-control{{ $errors->has('percent_client') ? ' is-invalid' : '' }}" name="percent_client" value="{{ old('percent_client') }}" required>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea name="docs_individual" id="docs_individual" class="form-control ">{{old('docs_individual')}}</textarea>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea name="docs_legal" id="docs_legal" class="form-control ">{{old('docs_legal')}}</textarea>
